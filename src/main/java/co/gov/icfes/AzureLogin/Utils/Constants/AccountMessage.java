...
/**
 * Clase para los mensajes de error de AccountService
 */
public class AccountMessage {

    public static final String ERROR01_TOKEN_INFOACCOUNT = "ERROR01_TOKEN_INFOACCOUNT - Ocurrió un error obteniendo el token de operación para consultar la información de la cuenta de usuario.";
